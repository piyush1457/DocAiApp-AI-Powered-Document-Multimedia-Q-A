...
class TranscriptionService:
    ...
    def extract_audio(video_path: str) -> str:
        ...
        try:
            ...
            raise TranscriptionError(f"Failed to extract audio from video: {e.stderr.decode()}")

    @staticmethod
    def split_audio(audio_path: str, chunk_duration_sec: int = 600, overlap_sec: int = 30) -> List[str]:
    ...
    async def transcribe_file(self, file_path: str, file_id: uuid.UUID, db: AsyncSession) -> List[Dict[str, Any]]:
        """
